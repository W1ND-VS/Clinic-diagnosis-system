        ...
        <div className="h-screen w-60 bg-dark-card border-r border-dark-border text-dark-text flex flex-col p-4">
            ...
            <ul className="space-y-2">
                <li>
                    ...
                    >
                        <i className="fas fa-file-medical mr-3"></i> Phiếu chỉ định
                    </NavLink>
                </li>
                <li>
                    <NavLink
                    ...
                    >
                        <i className="fas fa-vials mr-3"></i> Dịch vụ y tế
                    </NavLink>
                </li>
                <li>
                    <NavLink
                    ...
                    >
                        <i className="fas fa-clipboard-check mr-3"></i> Kết quả xét nghiệm
                    </NavLink>
                </li>
                <li>
                    <NavLink
                    ...
                    >
                        <i className="fas fa-chart-bar mr-3"></i> Báo cáo
                    </NavLink>
                </li>
            </ul>
